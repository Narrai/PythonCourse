...
def load_images(card_images):
    ...
    # for ech suit, retrieve the image for the cards
    for suit in suits:
...
def _deal_card(frame):
    ...
    # Add the card again to the back of the pack
...
deck = list(cards) + list(cards) + list(cards)  # Adding many list of cards
shuffle()
