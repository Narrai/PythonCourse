...
#         :param artist (Artist): At Artist object representing the song's creator.
#         :param duration (Optional[int]): Initial value for the 'duration' attribute.
#                     Will default to zero if not specified. SEE MORE ABOUT DOCSTRING PEP 257
#         """  # Just another way to write docstring
# help(Song)
...
class Album:
    ...
    Attributes:
        ...
        year (int): The year was album for the album.
...
class Artist:
    ...
    def add_album(self, album):
        ...
        Args:
            album (Album): Album object to  add to the list.
                If the albums is already present, it will not added again (although this is yet to implemented).
        """
    ...
    def add_song(self, name, year, title):
        ...
        Args:
            name (str): The name of the album.
            year (int): The year the albums was produced.
            title (str): The title of the song
        """
...
def find_object(field, object_list):
    """Check 'object_list' to see if an object with a 'name' attribute equal to 'field' exists, return it is so."""
...
def load_data():
    ...
    with open("albums.txt", 'r') as albums:
        for line in albums:
            ...
            #     # otherwise create a album object and store it in the artist's collection
